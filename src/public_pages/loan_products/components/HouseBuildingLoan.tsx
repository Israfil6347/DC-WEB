            ...
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify text-onSurface">
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    HDS deposit should be BDT 50,000, for a loan of around BDT
                    20 Lac and BDT 100,000, if the loan is over BDT 20 Lac.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    Approval plan copy of building & necessary update papers of
                    land.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                  ...
                  >
                    ...
                    letter & MICR Cheque. • Irrevocable General Power of
                    Attorney to be given to the name of Dhaka Credit surety.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
