            ...
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify text-onSurface">
                <motion.p
                  ...
                  transition={MyTransition.Spring.Low}
                >
                  Due to a lack of Working Capital, many entrepreneurs struggle
                  to develop and expand their businesses, Dhaka Credit’s
                  Industrial Loan is designed to support current and future
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Highest Loan: BDT 5,00,00,000 (5 Crore).
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    70% Loan of the existing industrial land value to be
                    sanctioned.
                  </motion.li>
                </ul>
                <motion.h4
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    The applicant must be a regular Member of Dhaka Credit.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    The applicant must be an established Industrial businessman.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    Updated business trade license, memorandum of article, and
                    deed of agreement to be submitted (for partnership
                    business).
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    ...
                    className="mt-2 flex gap-2"
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>Last 3
                    years bank statement, Audit report and TIN certificate with
                    return slip/acknowledgement.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    2.5% of the Sanctioned Loan is to be deposited before the
                    Loan sanction
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    The service charge for the applied Loan: is BDT 20,000.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
