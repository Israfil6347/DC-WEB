            ...
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify text-onSurface">
                <motion.p
                  ...
                  transition={MyTransition.Spring.Low}
                >
                  This loan scheme is designed for Members who want to take
                  loans against their share.
                </motion.p>

                <motion.h4
                  variants={MyVariants.SlideInFromRight}
                  transition={MyTransition.Spring.Low}
                  className="mt-5 text-lg font-semibold text-onSurfaceVariant md:text-xl lg:text-2xl"
                >
                  Features
                </motion.h4>
                <ul className="mt-5 list-disc">
                  ...
                  >
                    ...
                    Interest Rate: 12% yearly with 36 installments.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    Members can take a 90% loan against own share.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
