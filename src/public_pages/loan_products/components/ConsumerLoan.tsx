          ...
          <div className=" text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify text-onSurface">
                ...
                >
                  "Consumer Loan" is for those individuals who want to upgrade
                  their standard of living with the latest consumer goods but
                  require financial support to do so.
                </motion.p>
                <motion.h4
                  variants={MyVariants.SlideInFromRight}
                  transition={MyTransition.Spring.Low}
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    Loan Tenure: 2 Years (24 installments).
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    Can take this loan along with an existing "General Loan" or
                    other loans.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    10% will be paid by the applicant's total amount of product.
                  </motion.li>
                </ul>
              </div>
            </div>
