            ...
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              ...
              <div className="mb-4 p-1 text-justify text-onSurface">
                <motion.p
                  ...
                  transition={MyTransition.Spring.Low}
                >
                  This loan is for those individuals who are looking to expand
                  their business and increase their productivity & profit.
                </motion.p>
                <motion.h4
                  variants={MyVariants.SlideInFromRight}
                  transition={MyTransition.Spring.Low}
                ...
                <ul className="mt-5 list-disc ">
                  ...
                  >
                    ...
                    Highest Loan: BDT 100,00,000/- (1 Crore).
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    Loan Tenure: Highest 6 Years/ 72 Equal monthly Installment.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    Mortgage land, flat, and factory should be in the
                    applicant’s name.
                  </motion.li>
                </ul>
                <motion.h4
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    The lifespan of the Business should be at least 3 years old.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    40 Times share is required of applied loan
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    Land/Flat Mortgage papers & MICR Cheque.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    Self land/Flat Irrevocable General Power of Attorney to be
                    given to the name of Dhaka Credit
                  </motion.li>
                </ul>
              </div>
            </div>
