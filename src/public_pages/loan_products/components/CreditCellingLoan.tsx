          ...
          <div className=" text-onBackground">
            <div className="content bg-surface px-4 py-4 shadow-sm md:py-10 md:px-10 lg:py-20 lg:px-20">
              <motion.h2
                ...
                className="mb-2 p-1  text-lg font-bold md:text-2xl lg:text-3xl"
              >
                Credit Ceiling Loan
              </motion.h2>
              <motion.div className="mb-4 p-1 text-justify">
                <motion.p
                  variants={MyVariants.SlideInFromRight}
                  transition={MyTransition.Spring.Low}
                >
                  The Credit Ceiling Loan has been introduced to financially
                  support the established Christian businessmen in the Christian
                  Community and help them overcome different crises they may
                  face.
                </motion.p>
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    Interest can be paid monthly and once every three months.
                  </motion.li>
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    The loan amount will not be more than 70% of the mortgaged
                ...
                <ul className="mt-5 list-disc">
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    The applicant must be a regular Member of the Dhaka Credit.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    The business age has to be at least 7 years.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    TIN certificate with the last 3 years with tax return
                  ...
                  >
                    ...
                    letter to be submit with loan application.
                  </motion.li>
                  <motion.li
                    variants={MyVariants.SlideInFromRight}
                    transition={MyTransition.Spring.Low}
                  ...
                  >
                    <i className="fa-regular fa-circle-check mt-1"></i>
                    Land/Flat should be given as Irrevocable General Power of
                    Attorney to the name of Dhaka Credit.
                  </motion.li>
                </ul>
              </motion.div>
            </div>
